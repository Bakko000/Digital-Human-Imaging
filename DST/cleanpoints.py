...
content_pts_path='venv/DST/example/NBBresults/correspondence_A.txt'
style_pts_path='venv/DST/example/NBBresults/correspondence_B.txt'
activation_path='venv/DST/example/NBBresults/correspondence_activation.txt'
output_path='venv/DST/example/CleanedPts'
im_size = 256
NBB=1
max_num_points=80
b=10
